    ...
    >
      <div className="flex justify-around items-stretch h-16 max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="text-xs font-medium truncate w-full text-center">Donate</span>
        </NavLink>
        ...
        >
          ...
          <span className="text-xs font-medium truncate w-full text-center">Store</span>
        </NavLink>
        ...
        >
          ...
          <span className="text-xs font-medium truncate w-full text-center">Learn</span>
        </NavLink>
        ...
        >
          ...
          <span className="text-xs font-medium truncate w-full text-center">Podcast</span>
        </NavLink>
      </div>
    </nav>
  );
