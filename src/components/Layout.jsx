...
export default function Layout({ children }) {
  ...
  // Eliminada la lógica de redirección automática en mobile
  // El ErrorBoundary se encarga de manejar errores y redirigir
  // Esta lógica estaba causando redirecciones innecesarias
