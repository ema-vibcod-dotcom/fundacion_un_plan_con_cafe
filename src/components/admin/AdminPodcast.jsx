  ...
  const handleSave = async (episodeData) => {
    try {
      ...
      const supabaseData = {
        ...
        image_url: episodeData.imageUrl || null,
...
function EpisodeForm({ episode, onSave, onCancel }) {
  const [formData, setFormData] = useState({
    ...
    imageUrl: episode?.attributes?.imageUrl || episode?.attributes?.image_url || '',
  });
          ...
          <div className="mb-5 flex items-start gap-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-500">
                Agrega una imagen de portada del episodio usando una URL pública
              </p>
            </div>
          </div>
          <div>
